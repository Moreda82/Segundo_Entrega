...
public abstract class Vehiculo implements Conducible {
    ...
    /** Funcion nueva
     * Preguntamos si el coche tiene gasolina. 
     *
     * @return boolean Si tiene gasolina para poder arrancar
     */
    ...
    public boolean gasolina() {
        ...
        if (isGasolina()) {
            System.out.println(
                    "El "
                            + TIPO
                            + " tiene gasolina puede arrancar.");
            return false;
            
        } else {
            setGasolina(true);
            
            System.out.println("No tenias  gasolina   "
                    + TIPO  
                    +     "ahora ya puedes arrancar");
